...
if (my.canIUse('multiLevelSelect') && my.ap) {
...
if (my.canIUse('optionsSelect')) {
  lastInterfaceList.push({
    title: '选项选择器',
    entitle: 'optionsSelect',
    page: '../options-select/options-select',
  });
}
...
if (my.canIUse('getScreenBrightness') && my.ap) {
  lastOpenDeviceList.push({
    title: '屏幕亮度',
...
if (my.canIUse('textRiskIdentification') && my.ap) {
...
if (my.ap) {
  interFaceApiList = interFaceApiList.concat([
    {
      title: '联系人',
...
Page({
    ...
    arr: {
      ...
      list: [
        ...
        },
        {
          ...
          title: '界面',
          entitle: 'Interface',
          subs: [...interFaceApiList, ...lastInterfaceList],
        },
        {
  ...
  onLoad() {
    if (my.canIUse('contact-button') && my.ap) {
      const list = [
        ...this.data.arr.list,
        {
          icon: '/image/customer-service.png',
          title: '云客服',
          entitle: 'Contact',
          page: '../customer-service/customer-service',
        },
      ];
      this.setData({
        'arr.list': list,
    ...
    if (my.canIUse('on') && my.ap) {
      const list = [
        ...this.data.arr.list,
        {
          icon: '/image/api_event.png',
          title: '容器事件',
          entitle: 'Events',
          page: '../events/events',
        },
